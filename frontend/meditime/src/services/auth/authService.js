...
// Note: buildCallbackUrl non utilisé dans React Native
// Les redirections OAuth se font différemment dans les apps mobiles
...
export const registerWithEmail = async (email, password, name) => {
  try {
    const { error } = await supabase.auth.signUp({
      email,
      password,
      // Pas de redirection en React Native
    });
    if (error) {
